      ...
      <div className="lg:w-2/3">
        <div>
          ...
          <p className="my-6 text-slate-500">
            ...
            temporibus amet, quas nihil officiis itaque consequuntur, eligendi
            quia quisquam velit quam non quibusdam illo modi ut? Libero ad quia
            quos molestiae, sit, cumque id iusto sint debitis excepturi
            corporis, nulla impedit! Fuga et id soluta maxime. Repellendus ab
